...
public class RequestBST {
    ...
    public CustomerBST cust = new CustomerBST(); // customerBST of the request
     ...
     */
    public RequestBST(int req, video v) {
        requestSpecifier = req;
        vid = v;
    }

    /**
     * constructor with a request in, a customerBST object, and video object passed
     * in
     * 
     * @param req the type of request
     * @param c   the customerBST object
     * @param v   the video object
     */
    public RequestBST(int req, CustomerBST c, video v) {
        requestSpecifier = req;
        cust = c;
        vid = v;
    }
     ...
     */
    public CustomerBST getCust() {
        return cust;
    }

    /**
     * sets the customer instance variable to the new passed in customerBST object
     * 
     * @param c
     */
    public void setCust(CustomerBST c) {
        cust = c;
    }
