/**
 * am implementation of the CustomerBST. the class allows the creation of
 * customer objects that store name and id of customer as a string and use a
 * binary search tree in the form of a TreeMap to hold video objects
 * 
 * @author John
 */
public class CustomerBST {
    ...
    public TreeMap<String, video> rentedVideo = new TreeMap<>();
    ...
    public CustomerBST(String n, String i) {
        name = n;
        customerId = i;
    }
     ...
     */
    public CustomerBST(String n, String i, video v) {
        name = n;
        customerId = i;
     ...
     */
    public TreeMap<String, video> removeVideo() {
        TreeMap<String, video> temp = new TreeMap<>();
