...
public class BSTAnalysis {
    ...
    private MyQueue<RequestBST> queue = new MyQueue<>(); // a queue used to hold the requests
     ...
     */
    public BSTAnalysis(int v, int c, int a) {
        vids = v;
        custs = c;
        actions = a;
    }
    ...
    public void runMenu() {
        ...
        for (int i = custs; 0 < i; i--) // for cust to 0 gernerate customers
        {
            ...
            CustomerBST custom = new CustomerBST(x, x); // creates new customerSLL object with name and id set to x
        ...
        for (int i = actions; i > 0; i--) // for actions to 0 generate random request objects
        {
            ...
            CustomerBST CRIn = new CustomerBST(CR, CR); // creates new CustomerBST object with CR as name and id
            ...
            RequestBST req = new RequestBST(actionRand, CRIn, VRIn); // creates new request object with random field
                                                                     // variables
    ...
    public void runRequests() {
        ...
        {
            RequestBST requestType = new RequestBST(); // create new RequestBST object
        ...
        // print the time
        System.out.println("the total run time of all requests in BST was: " + elapsedTime + " nano seconds");
        exit();
    }
     ...
     */
    public void addCustomer(CustomerBST c) {
     ...
     */
    public boolean checkCustomer(CustomerBST c) {
        String id = c.getId();
     ...
     */
    public boolean checkOutVideo(video v, CustomerBST c) {
